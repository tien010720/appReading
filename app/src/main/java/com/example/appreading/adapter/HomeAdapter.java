...
public class HomeAdapter extends RecyclerView.Adapter<HomeAdapter.MyItemViewHolder> implements Filterable {
    private ArrayList<HomeItemModel> list;
    ArrayList<HomeItemModel> listFull;
    Context context;
    public HomeAdapter(Context context, ArrayList<HomeItemModel> list){
        this.list= list;
    ...
    public MyItemViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.home_main_item,
                parent, false);
